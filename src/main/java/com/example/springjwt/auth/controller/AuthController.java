...
import com.example.springjwt.auth.event.OnGenerateResetLinkEvent;
import com.example.springjwt.auth.event.OnRegenerateEmailVerificationEvent;
import com.example.springjwt.auth.event.OnUserAccountChangeEvent;
import com.example.springjwt.auth.event.OnUserRegistrationCompleteEvent;
import com.example.springjwt.auth.exception.*;
import com.example.springjwt.auth.model.CustomUserDetails;
import com.example.springjwt.auth.model.payload.*;
...
import com.example.springjwt.auth.security.JwtTokenProvider;
